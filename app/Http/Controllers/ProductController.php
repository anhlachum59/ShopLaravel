...
class ProductController extends Controller
{
    ...
    public function all_product()
    {
        ...
        return view('backend.admin_layout')->with('admin.product.all_product',$manager_product);
    }
    ...
    public function edit_product($product_id)
    {
        ...
        return view('backend.admin_layout')->with('admin.product.edit_product',$manager_product); 
    }
