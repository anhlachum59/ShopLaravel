...
class CategoryProductController extends Controller
{
    ...
    public function all_category_product()
    {
        ...
        return view('backend.admin_layout')->with('admin.categoryproduct.all_category_product',$manager_category_product);
    }
    ...
    public function edit_category_product($category_product_id)
    {
        ...
        return view('backend.admin_layout')->with('admin.categoryproduct.edit_category_product',$manager_category_product); 
    }
